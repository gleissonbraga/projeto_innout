    ...
    <div>
        <form class="mb-4" action="#" method="post">
            <div class="input-group">
                <select name="user" id="" class="form-control" aria-placeholder="Selecione o usuário">
                ...
                <select name="period" id="" class="form-control ml-2" placeholder="Selecione o período">
                    <?php
